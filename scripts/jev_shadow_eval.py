...
from jev_shadow.provider import DisabledProvider, VercelJevProvider
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default="disabled",
        help="Network provider. Default never makes a network call.",
    )
    ...
    raw = json.loads(text)
    provider = VercelJevProvider() if args.provider == "jev" else DisabledProvider()
